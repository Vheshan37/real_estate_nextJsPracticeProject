...
export default function PaymentPage() {
    ...
    const summaryCards = [
        { title: "Total Collected", value: "Rs 2.4M" },
        { title: "Pending", value: "Rs 55K" },
        { title: "Overdue", value: "Rs 55K" },
        { title: "Collection Rate", value: "98%" },
    ];
        ...
        <div className="flex-1 overflow-auto min-h-screen">
            ...
            <div className="flex justify-between items-center w-full gap-2 pb-2 p-10">
                <div className="flex flex-col flex-1">
                    <p className="text-2xl font-bold text-neutral-900">Payments & Rent Tracking</p>
                    <p className="text-neutral-600 text-sm">Monitor rent collection and payment status</p>
                </div>
            </div>
